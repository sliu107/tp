...
public class AddFlashcardToGroupCommandTest {
    ...
    public void addFlashcardToGroupCommand_execute_Successfully() throws HistoryFlashcardException {
        ...
        FlashcardGroup actualGroup1 = new FlashcardGroup(GROUP_NAME, DESCRIPTION, fullFlashcardList,
        ...
        FlashcardGroup actualGroup2 = new FlashcardGroup(GROUP_NAME, DESCRIPTION, fullFlashcardList,
